...
default_t defaults[] =
{
  ...
  {"screen_width",{(int*)&desired_screenwidth},{640}, 320, MAX_SCREENWIDTH,
   def_int,ss_none},
  {"screen_height",{(int*)&desired_screenheight},{480},200,MAX_SCREENHEIGHT,
   def_int,ss_none},
  ...
  {"gl_depthbuffer_bits",{&gl_depthbuffer_bits},{16},16,32,
   def_int,ss_none},
  {"gl_tex_filter_string", {NULL,(const char**)&gl_tex_filter_string}, {0,"GL_LINEAR"},UL,UL,
   def_str,ss_none},
  {"gl_tex_format_string", {NULL,(const char**)&gl_tex_format_string}, {0,"GL_RGB5_A1"},UL,UL,
   def_str,ss_none},
