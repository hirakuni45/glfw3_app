...
/*! @brief The function signature for drop files callbacks.
 *
 *  This is the function signature for drop files callback functions.
 *
 *  @param[in] count Number of file path list.
 *  @param[in] strings List that shows the file path that is encoded in UTF-8.
 *
 *  @sa glfwSetDropfilesCallback
 *
 *  @ingroup input
 */
typedef void (* GLFWdropfilesfun)(GLFWwindow*,int,const char**);
...
GLFWAPI int glfwGetDropfilesId(GLFWwindow* window);
GLFWAPI const char** glfwGetDropfilesString(GLFWwindow* window, int* count);

/*! @brief Sets the Drop files callback.
 *
 *
 *  @param[in] window The window whose callback to set.
 *  @param[in] cbfun The new callback, or `NULL` to remove the currently set
 ...
 *  @ingroup input
 */
GLFWAPI GLFWdropfilesfun glfwSetDropfilesCallback(GLFWwindow* window, GLFWdropfilesfun cbfun);
