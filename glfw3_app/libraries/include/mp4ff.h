...
const char *mp4ff_meta_get_item(const mp4ff_t *f, unsigned int index);
const char *mp4ff_meta_get_value(const mp4ff_t *f, unsigned int index);
size_t mp4ff_meta_get_size(const mp4ff_t *f, unsigned int index);
