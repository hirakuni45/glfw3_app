...
public:
	...
	bool seekCur(uint32_t pos)
	{
		return fio_.seek(pos, utils::file_io::SEEK::CUR);
	}


	bool seekSet(uint32_t pos)
	{
		return fio_.seek(pos, utils::file_io::SEEK::SET);
	}


	void fgets(char* dst, uint32_t len)
	{
		fio_.read(dst, len);		
	}
...
protected:
  ...
  void      *_sd;               ///< SDFat library descriptor supplied by calling program
