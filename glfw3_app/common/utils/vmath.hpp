...
namespace vtx {
	...
	*/
	//-----------------------------------------------------------------//
	static bool line_hit_triangle(const fvtx& p, const fvtx& q, const fvtx v[3], fvtx& cp)
	{
		fvtx P, A, B, C;
		normalization(q - p, P);
	...
	*/
	//-----------------------------------------------------------------//
	static bool triangle_in_point(const fpos& pos, const fvtx& v0, const fvtx& v1, const fvtx& v2)
	{
	...
	*/
	//-----------------------------------------------------------------//
#if 0
	static bool polygon_in_point(const fpos& pos, const fpositions& src)
	{
		fpos vv[3];
	...
	*/
	//-----------------------------------------------------------------//
	static bool triangle_intersect(const fvtx& org, const fvtx& dir, const fvtx tv[3], fvtx& crs)
	{
		fvtx e1 = tv[1] - tv[0];
		fvtx e2 = tv[2] - tv[0];
...
//		tuv.z = v;
	...
	*/
	//-----------------------------------------------------------------//
	static bool triangle_intersect2(const fvtx& org, const fvtx& end, const fvtx tv[3], fvtx& crs)
	{
		fvtx vec = end - org;
	...
	*/
	//-----------------------------------------------------------------//
	static int quadrangle_intersect(const fvtx& org, const fvtx& dir, const fvtxs& vlist, fvtx& crs)
	{
	...
	*/
	//-----------------------------------------------------------------//
	static int quadrangle_intersect2(const fvtx& org, const fvtx& end, const fvtxs& vlist, fvtx& crs)
	{
	...
	*/
	//-----------------------------------------------------------------//
	static bool sphere_line_collision(float r, const fvtx& cen, const fvtx& org, const fvtx dir, fvtx& crs)
	{
...
//		pOut_t = t;
	...
	static void surface_ratio(const fpos& scr, const fvtxs& suf, const fvtxs& in, fvtx& out)
	{
