...
namespace gui {
	...
	*/
	...
	struct widget_editor : public widget {
		...
		*/
		...
		struct param {
			...
			param() noexcept : font_("Inconsolata"), font_width_(0), font_height_(18), height_(18),
				auto_fit_(true) { }
		};
	...
	public:
		...
		*/
		//-----------------------------------------------------------------//
		widget_editor(widget_director& wd, const widget::param& bp, const param& p) noexcept :
		...
		*/
		//-----------------------------------------------------------------//
		const char* type_name() const noexcept override { return "editor"; }
