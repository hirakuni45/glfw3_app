...
namespace gui {
	...
	*/
		...
		*/
		...
		struct param {
			...
			*/
			...
			param(type t) noexcept : type_(t), pos_(0), size_(0), width_(4), ofs_(0),
	...
	public:
		...
		*/
		//-----------------------------------------------------------------//
		widget_border(widget_director& wd, const widget::param& bp, const param& p) noexcept :
		...
		*/
		//-----------------------------------------------------------------//
		const char* type_name() const noexcept override { return "border"; }
