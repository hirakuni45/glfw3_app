...
namespace gui {
	...
	*/
	...
	struct widget_text : public widget {
		...
		*/
		...
		struct param {
			...
			param(const std::string& text = "") noexcept : text_param_(text,
	...
	public:
		...
		*/
		//-----------------------------------------------------------------//
		widget_text(widget_director& wd, const widget::param& bp, const param& p) noexcept :
		...
		*/
		//-----------------------------------------------------------------//
		const char* type_name() const noexcept override { return "text"; }
