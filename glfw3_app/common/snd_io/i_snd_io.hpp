...
namespace al {
	...
	*/
	...
	public:
		...
		*/
		//-----------------------------------------------------------------//
		virtual const i_audio* get_stream() const = 0;
		...
		*/
		...
		//-----------------------------------------------------------------//
		/*!
			@brief	オーディオ・インターフェースを取得
			@return	オーディオインターフェース
		*/
		//-----------------------------------------------------------------//
		virtual const i_audio* get_audio_if() const = 0;
		...
		*/
		//-----------------------------------------------------------------//
		virtual void set_audio_if(const i_audio* aif) = 0;
