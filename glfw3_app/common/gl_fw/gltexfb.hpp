...
namespace gl {
	...
	*/
	...
	public:
		...
		*/
		//-----------------------------------------------------------------//
		int initialize(int width, int height, int depth);
...
//			tex_size_.set(tw, th);
		...
		*/
		//-----------------------------------------------------------------//
		void rendering(imgtype type, const char* img, int alpha = 255);
