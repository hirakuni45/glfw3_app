...
namespace img {
	...
	*/
	...
	class pvr_io : public i_img_io {
		...
		static void interpolateColours(Pixel32 P, Pixel32 Q, Pixel32 R, Pixel32 S, Pixel128S *pPixel, uint8_t ui8Bpp)
		{
		...
		static void pvrtcGetDecompressedPixels(const PVRTCWord& P, const PVRTCWord& Q, const PVRTCWord& R, const PVRTCWord& S, Pixel32* pColourData, uint8_t ui8Bpp)
		{
		...
		static void mapDecompressedData(const Pixel32* pWord, const PVRTCWordIndices& words, uint8_t ui8Bpp, shared_img img, bool flip)
		{
			uint32_t ui32WordWidth = 4;
			uint32_t ui32WordHeight = 4;
			if(ui8Bpp == 2) {
		...
		static uint32_t pvrtc_decompress(const void* pCompressedData, uint32_t ui32Width, uint32_t ui32Height, uint32_t ui8Bpp, shared_img img, bool flip)
		{
			uint32_t ui32WordWidth = 4;
			uint32_t ui32WordHeight = 4;
			if(ui8Bpp == 2) {
