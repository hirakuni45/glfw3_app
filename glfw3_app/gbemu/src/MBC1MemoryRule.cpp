...
void MBC1MemoryRule::SaveRam(OSTREAM& file)
{
...
bool MBC1MemoryRule::LoadRam(ISTREAM& file, s32 fileSize)
{
...
void MBC1MemoryRule::SaveState(OSTREAM& stream)
{
    using namespace std;
...
void MBC1MemoryRule::LoadState(ISTREAM& stream)
{
    using namespace std;
