...
void MBC3MemoryRule::SaveRam(OSTREAM& file)
{
...
bool MBC3MemoryRule::LoadRam(ISTREAM& file, s32 fileSize)
{
...
void MBC3MemoryRule::SaveState(OSTREAM& stream)
{
//    using namespace std;
...
void MBC3MemoryRule::LoadState(ISTREAM& stream)
{
//    using namespace std;
