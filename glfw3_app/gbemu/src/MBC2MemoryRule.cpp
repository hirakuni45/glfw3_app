...
void MBC2MemoryRule::SaveRam(OSTREAM& file)
{
...
bool MBC2MemoryRule::LoadRam(ISTREAM& file, s32 fileSize)
{
...
void MBC2MemoryRule::SaveState(OSTREAM& stream)
{
    using namespace std;
...
void MBC2MemoryRule::LoadState(ISTREAM& stream)
{
    using namespace std;
