...
typedef app::cnc_main start_app;

static const char* window_key_ = { "application/window" };
static const char* app_title_ = { "CNC Manage" };
static const vtx::spos start_pos_(10, 50);
static const vtx::spos start_size_(1280, 1024);
static const vtx::spos limit_size_(1280, 1024);
